...
export default function Projects() {
  return (
    <section id="projects" className="py-16 md:py-24 bg-bg scroll-mt-20">
      <div className="max-w-6xl mx-auto px-6">
        <motion.div {...sectionAnim} className="mb-10 md:mb-16">
          <p className="text-accent text-sm font-semibold tracking-widest uppercase mb-2">What I've built</p>
            ...
            >
              ...
              <div className="mt-auto pt-2 flex items-center gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 text-sm text-accent hover:text-white font-medium transition-colors duration-200"
                >
                  <GitHubIcon />
                  View on GitHub
                </a>
                {project.liveUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-1 text-sm text-muted hover:text-accent font-medium transition-colors duration-200"
                  >
                    Live demo ↗
                  </a>
                )}
